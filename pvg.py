...
class mainNotebook(wx.Notebook):
    """
    The main notebook containing all the panels for displaying videos and
...
# %%
    def __set_properties(self, window_title, size_ratio):
        ...
        Set the size of the window relative to the size of the user's display.
...
# %%
    ...
    def onAbout(self, event):
        ...
        # Put the message, information icon, and an ok button in a window.
...
# %%
    def onFileSaveAs(self, event):
        ...
        # adding additional spaces to wildcard string will mess it up!
...
# %%
    def onFileOpen(self, event):
        ...
        if dlg.ShowModal() == wx.ID_OK:      # show the open-file window
            path = dlg.GetPath()             # file is created if doesn't exist?   # what I really want here is to load cfg and fill in thumbnails appropriately
            options.New(path)
...
"""
screen_width = GetSystemMetrics(0)     # get screen resolution of this monitor
